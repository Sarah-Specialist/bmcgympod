    ...
    return (
        <div className="equipment">
            <div className="rowone">
                ...
                <img src="https://i.ibb.co/k8CMN2x/gp-smart-mirror.jpg" alt="smart mirror" className="ptx" />
                <img src="https://i.ibb.co/cxq2qfV/gp-exercise-mat.jpg" alt="exercise mat" />
                <img src="https://i.ibb.co/47krg7r/gp-resistance-band.jpg" alt="resistance band" className="band" />
                
            </div>
            <div className="rowtwo">
                <img src="https://i.ibb.co/6Jf18dr/Whats-App-Image-2022-06-24-at-11-10-38-AM.jpg" alt="cable pulley" className="cable" height="100" width="150" />
                ...
                <img src="https://i.ibb.co/bFrHqcN/gp-weight-plates.jpg" alt="weight plates" className="plates" />
            </div>
        </div>
    )
}